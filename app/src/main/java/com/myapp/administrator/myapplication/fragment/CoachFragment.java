...
import com.myapp.administrator.myapplication.activity.BaiduMapActivity;
    ...
    private void setViewListener() {
        ...
        mBaiduMap.setOnMarkerClickListener(new BaiduMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                Toast.makeText(getActivity(), buildings.get(marker.getZIndex()).getBuildingName(), Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
...
//        Log.d("test", "CoachFragment. onDetach");
//        // 退出时销毁定位
//        mLocClient.stop();
//        // 关闭定位图层
